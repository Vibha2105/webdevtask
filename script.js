...
function setup() {
    ...
    playButton.addEventListener('click', () => {
        ...
        document.querySelector('#message').textContent = `Welcome to Vibha's memory tile game! The sequence will get harder and you must click the tiles in the right order to advance to the next round.`
        gameOver = false;
        roundClicks = 0;
        playRound()
        allTiles.forEach(element => {
